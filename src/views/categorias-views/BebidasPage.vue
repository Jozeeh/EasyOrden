                    ...
                    <ion-row>
                        <ion-col size="6" size-xm="6">
                            ...
                            <ion-card>
                                ...
                                <ion-card-header>
                                    ...
                                    <ion-card-title>Blue Label</ion-card-title>
                                </ion-card-header>
                                ...
                                <ion-card-content>
                                    ...
                                    <br>
                                    <!-- AGREGAR AL CARRITO -->
                                    <ion-button color="success" class="btnAgregarCarrito">
                                        Agregar
                        ...
                        <ion-col size="6" size-xm="6">
                            <ion-card>
                                ...
                                <ion-card-header>
                                    <ion-card-subtitle>Bebidas</ion-card-subtitle>
                                    <ion-card-title>Coca-Cola</ion-card-title>
                                </ion-card-header>
                        ...
                        <ion-col size="6" size-xm="6">
                            <ion-card>
                                ...
                                <ion-card-header>
                                    <ion-card-subtitle>Bebidas</ion-card-subtitle>
                                    <ion-card-title>Limonada</ion-card-title>
                                </ion-card-header>
                        ...
                        <ion-col size="6" size-xm="6">
                            <ion-card>
                                ...
                                <ion-card-header>
                                    <ion-card-subtitle>Bebidas</ion-card-subtitle>
                                    <ion-card-title>Licuado</ion-card-title>
                                </ion-card-header>
